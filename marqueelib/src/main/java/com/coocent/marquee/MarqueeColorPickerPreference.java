 ...
 */
public class MarqueeColorPickerPreference
        extends
        Preference
        implements
        Preference.OnPreferenceClickListener,
        MarqueeColorPickerDialog.OnColorChangedListener {

    View mView;
    MarqueeColorPickerDialog mDialog;
    private int mValue = Color.BLACK;
    private float mDensity = 0;
    private boolean mAlphaSliderEnabled = false;
    private boolean mHexValueEnabled = false;

    public MarqueeColorPickerPreference(Context context) {
        super(context);
        init(context, null);
    }

    public MarqueeColorPickerPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public MarqueeColorPickerPreference(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void setPreviewColor() {
        ...
        iView.setBackgroundDrawable(new MarqueeAlphaPatternDrawable((int) (5 * mDensity)));
    ...
    protected void showDialog(Bundle state) {
        mDialog = new MarqueeColorPickerDialog(getContext(), mValue);
