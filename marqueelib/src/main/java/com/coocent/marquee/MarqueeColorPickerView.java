 ...
 */
public class MarqueeColorPickerView extends View {
    ...
    private MarqueeAlphaPatternDrawable mAlphaPattern;
    ...
    public MarqueeColorPickerView(Context context) {
        this(context, null);
    }

    public MarqueeColorPickerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MarqueeColorPickerView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void setUpAlphaRect() {
        ...
        mAlphaPattern = new MarqueeAlphaPatternDrawable((int) (5 * mDensity));
